...
p
p <- ggdraw() +
  draw_plot(AUC2, x = 0, y = 0.5, width = 0.5, height = 0.5) +
  draw_plot(AUC3, x = 0.5, y = 0.5, width = 0.5, height = 0.5) +
  draw_plot(C2, x = 0, y = 0, width = 0.5, height = 0.5) +
  draw_plot(C3, x = 0.5, y = 0, width = 0.5, height = 0.5) +
  draw_plot_label(label = c("a", "b", "c","d"), size = 15,
                  x = c(0, 0.55,0, 0.55), y = c(1, 1, 0.5,0.5))
p
ggsave(paste0(pathfigures_tables,"figure3.jpg"),width = 11.84, height = 7.65 )
