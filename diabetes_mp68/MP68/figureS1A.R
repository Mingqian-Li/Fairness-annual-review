...
p <- ggplot(data_all, aes(x = FP,y = TP, colour = year)) +
  geom_line(aes(linetype = model),size = 1) +
  coord_equal() +
  style_roc(ylab = "sensitivity", xlab = "1 - specificity") +
  scale_linetype_manual(name = "Model", values = c("solid", "twodash"), labels = c("individual weighted IA ","number autoantibodies")) +
...
p
 ...
 ggsave(paste0(pathfigures_tables ,"figureS1A.jpg"),width = 6.8,height = 6.8)
# 
# library("tidyverse")
# library("officer")
# library("rvg")
...
#   print(target = "C:/Users/Lauric/Dropbox/TEDDY prediction model paper/figures and tables/figureS3PanelA.pptx")
